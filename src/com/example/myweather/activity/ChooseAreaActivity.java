...
public class ChooseAreaActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		isFromWeatherActivity=getIntent().getBooleanExtra("from_weater_activity", false);
		Log.d("ChooseAreaActivity", "onCreate"+isFromWeatherActivity);
	...
	private void queryCities(){
		...
		Log.d("queryCities", ""+cityList.size());
		if(cityList.size()>0){
			dataList.clear();
